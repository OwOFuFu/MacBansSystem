...
import com.md_4.macbans.events.CheckJoin_1_13_2_R1;
import com.md_4.macbans.functions.MacAddress_1_13_2_R1;
import com.md_4.macbans.security.AdvancedLicense_1_13_2_R1;
import com.md_4.macbans.sql.MySQL_1_13_2_R1;
import com.md_4.macbans.utils.Tab_1_13_2_R1;
...
public final class MacBans_1_13_2_R1 extends JavaPlugin {

    public static MySQL_1_13_2_R1 SQL;

    private static MacBans_1_13_2_R1 instance;

    public static MacBans_1_13_2_R1 getInstance(){
        return instance;
    }

    public void Commands(){
        getCommand("macbans").setExecutor(new com.md_4.macbans.commands.MacBans_1_13_2_R1());
    }

    public void TabCompletion(){
        getCommand("macbans").setTabCompleter(new Tab_1_13_2_R1());
    }

    public void Events(){
        getServer().getPluginManager().registerEvents(new CheckJoin_1_13_2_R1(), this);
    }
    ...
    public void onEnable() {
        ...
        if(SQL.isConnected()){
            ...
            try {
                MacAddress_1_13_2_R1.createTable();
        ...
        AdvancedLicense_1_13_2_R1.ValidationType vt = new AdvancedLicense_1_13_2_R1(getConfig().getString("License-Key").toString(), "https://rload.eu/labscriptadd/verify.php", MacBans_1_13_2_R1.getInstance()).isValid();
        if(
                vt == vt.KEY_OUTDATED
                        || vt == vt.NOT_VALID_IP
                        || vt == vt.KEY_NOT_FOUND
            ...
            getServer().getPluginManager().disablePlugin(MacBans_1_13_2_R1.getInstance());
