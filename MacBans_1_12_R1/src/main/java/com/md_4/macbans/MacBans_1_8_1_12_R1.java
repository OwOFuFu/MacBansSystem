...
import com.md_4.macbans.utils.Tab_1_8_1_12;
...
public final class MacBans_1_8_1_12_R1 extends JavaPlugin {

    public static MySQL_1_8_1_12 SQL;

    private static MacBans_1_8_1_12_R1 instance;

    public static MacBans_1_8_1_12_R1 getInstance(){
        return instance;
    }

    public void Commands(){
        getCommand("macbans").setExecutor(new MacBans_1_8_1_12());
    }

    public void TabCompletion(){
        getCommand("macbans").setTabCompleter(new Tab_1_8_1_12());
    }
    ...
    public void onEnable() {
        ...
        if(SQL.isConnected()){
            ...
            try {
                MacAddress_1_8_1_12.createTable();
        ...
        AdvancedLicense_1_8_1_12.ValidationType vt = new AdvancedLicense_1_8_1_12(getConfig().getString("License-Key").toString(), "https://rload.eu/labscriptadd/verify.php", MacBans_1_8_1_12_R1.getInstance()).isValid();
        if(
                vt == vt.KEY_OUTDATED
                        || vt == vt.NOT_VALID_IP
                        || vt == vt.KEY_NOT_FOUND
            ...
            getServer().getPluginManager().disablePlugin(MacBans_1_8_1_12_R1.getInstance());
