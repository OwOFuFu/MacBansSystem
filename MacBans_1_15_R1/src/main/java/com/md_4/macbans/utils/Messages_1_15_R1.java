...
public class Messages_1_15_R1 {
    ...
    public static String ConsoleIsNotAPlayer(){
        return lang.equals("It") ? Format_1_15_R1.color(lang_it_config.getString("Msg.ConsoleIsNotAPlayer")) : "";
    }
    ...
    public static String ConsoleIsNotAPlayerEN(){
        return lang.equals("En") ? Format_1_15_R1.color(lang_en_config.getString("Msg.ConsoleIsNotAPlayer")) : "";
    }
