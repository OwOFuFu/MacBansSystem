...
public class AdvancedLicense_1_13_R1 {
	...
	public AdvancedLicense_1_13_R1(String licenseKey, String validationServer, Plugin plugin) {
		this.licenseKey = licenseKey;
		this.plugin = plugin;
		this.validationServer = validationServer;
	}

	public AdvancedLicense_1_13_R1 setSecurityKey(String securityKey) {
		this.securityKey = securityKey;
		return this;
	}

	public AdvancedLicense_1_13_R1 setConsoleLog(LogType logType) {
		this.logType = logType;
		return this;
	}

	public AdvancedLicense_1_13_R1 debug() {
		debug = true;
		return this;
	}
